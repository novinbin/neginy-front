...
import { cityStateMapping } from "../hall/state";
...
const Ceremonies = () => {
  ...
  const onSubmit = async (values) => {
    ...
    await axios
      .post("/api/ceremony/business-info", encodedFormData)
      .then(async (response) => {
        ...
        <Form {...form}>
          <div className="mx-auto w-4/5">
            <form onSubmit={handleSubmit(onSubmit)}>
              <div className="grid grid-cols-2 gap-x-3 gap-y-2 max-lg:grid-cols-1">
                <FormField
                  control={control}
                  name="business_name"
                  render={({ field }) => (
