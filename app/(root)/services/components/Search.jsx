...
function Search() {
  ...
  const fetchStateAndCityData = async () => {
    await axios
      ...
      .catch((error) => {
        toast.error(<ToastError text={"مشکلی پیش آمد مجدد تلاش کنید"} />);
      });
  };
  ...
  const fetchServicesData = async () => {
    await axios
      ...
      .catch((error) => {
        toast.error("مشکلی پیش آمد مجدد تلاش کنید");
      });
  };
        ...
        <div className="mx-auto w-11/12 pt-9">
          <div>
            <Menubar className="mx-auto space-x-0 rounded-xl p-0 shadow-lg max-lg:flex max-lg:h-[17rem] max-lg:flex-col max-lg:gap-4 lg:h-14 lg:w-[920px]">
              ...
              {isLoading ? (
                <div className="flex h-14 w-full cursor-wait items-center justify-center rounded-l-xl bg-[#68807A] text-center text-white">
