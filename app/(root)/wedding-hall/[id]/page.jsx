...
import { Instagram, MapPin, Phone, SquarePen, Star } from "lucide-react";
  ...
  return (
    <div className="bg-[#F5F2EE]">
      <div className="mx-auto w-4/5 py-20">
          ...
          <div className="flex flex-col gap-5">
            <div className="flex items-center gap-2">
              ...
              <h2>
                امتیاز
                <span className="px-3">
                  {farsiNumber(data?.data?.rating?.rating)} / {farsiNumber(5)}
                </span>
              </h2>
            </div>
            <div className="flex items-center gap-2">
              <SquarePen />
              <p>
                تعداد نظرات : {farsiNumber(data?.data?.rating?.total_points)}
              </p>
            </div>
            <div className="flex items-center gap-2">
              <MapPin />
        ...
        <PaginationComponent
          total={dataComment?.data?.meta?.total || 0}
          page={dataComment?.data?.meta?.current_page || 1}
          perPage={dataComment?.data?.meta?.per_page || 10}
        />
      </div>
    </div>
  );
