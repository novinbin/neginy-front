  ...
  (
    ...
    const toggleAll = () => {
      if (selectedValues.length === options.length) {
        ...
        const allValues = options.map((option) => option.feature);
              ...
              <div className="flex justify-between items-center w-full">
                <div className="flex flex-wrap items-center">
                  {selectedValues.slice(0, maxCount).map((value) => {
                    const option = options.find((o) => o.feature === value);
          ...
          <Command>
            ...
            <CommandList>
              ...
              <CommandGroup>
                ...
                {options.map((option) => {
                  const isSelected = selectedValues.includes(option.feature);
                  return (
                    <CommandItem
                      key={option.feature}
                      onSelect={() => toggleOption(option.feature)}
                      className="cursor-pointer"
                    >
                      <div
                        className={cn(
